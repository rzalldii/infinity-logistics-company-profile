        ...
        <div class="container">
            <div class="row gy-5">
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="service-box">
                        ...
                        <div class="services-list">
                            <a href="{{ route('nvocc') }}" class="active"><i class="bi bi-arrow-right-circle"></i><span x-text="translations.messages.nvocc"></span></a>
                ...
                <div class="col-lg-8 ps-lg-5" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <a href="{{ route('nvocc-schedule') }}" class="more-details-btn" x-text="translations.messages.nvocc_schedule"></a>
                </div>
            </div>
        </div>
    </section>
