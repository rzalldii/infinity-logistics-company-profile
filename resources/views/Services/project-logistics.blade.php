                    ...
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                        <div class="service-box">
                            ...
                            <div class="services-list">
                                ...
                                <a href="{{ route('project-logistics') }}" class="active"><i
                        ...
                        <div class="service-details-slider swiper init-swiper">
                            ...
                            <div class="swiper-wrapper align-items-center">
                                <div class="swiper-slide">
                                    <a href="<?php echo url('/'); ?>/img/services details/PROJECT LOGISTICS1.webp"
                                        data-gallery="services-project-logistics" class="glightbox preview-link">
                                        <img src="<?php echo url('/'); ?>/img/services details/PROJECT LOGISTICS1.webp"
                                            class="img-fluid services-img-swipe" alt="PROJECT LOGISTICS1">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="<?php echo url('/'); ?>/img/services details/PROJECT LOGISTICS2.webp"
                                        data-gallery="services-project-logistics" class="glightbox preview-link">
                                        <img src="<?php echo url('/'); ?>/img/services details/PROJECT LOGISTICS2.webp"
                                            class="img-fluid services-img-swipe" alt="PROJECT LOGISTICS2">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="<?php echo url('/'); ?>/img/services details/PROJECT LOGISTICS3.webp"
                                        data-gallery="services-project-logistics" class="glightbox preview-link">
                                        <img src="<?php echo url('/'); ?>/img/services details/PROJECT LOGISTICS3.webp"
                                            class="img-fluid services-img-swipe" alt="PROJECT LOGISTICS3">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="<?php echo url('/'); ?>/img/services details/PROJECT LOGISTICS4.webp"
                                        data-gallery="services-project-logistics" class="glightbox preview-link">
                                        <img src="<?php echo url('/'); ?>/img/services details/PROJECT LOGISTICS4.webp"
                                            class="img-fluid services-img-swipe" alt="PROJECT LOGISTICS4">
                                    </a>
                                </div>
                            </div>
