            ...
            <div class="container">
                <div class="row gy-5">
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                        <div class="service-box">
                            ...
                            <div class="services-list">
                                ...
                                <a href="{{ route('freight-forwarding') }}" class="active"><i
                    ...
                    <div class="col-lg-8 ps-lg-5" data-aos="fade-up" data-aos-delay="200">
                        <div class="service-details-slider swiper init-swiper">
                            ...
                            <div class="swiper-wrapper align-items-center">
                                <div class="swiper-slide">
                                    <a href="<?php echo url('/'); ?>/img/services details/FREIGHT FORWARDING1.webp"
                                        data-gallery="services-freight-forwarding" class="glightbox preview-link">
                                        <img src="<?php echo url('/'); ?>/img/services details/FREIGHT FORWARDING1.webp"
                                            class="img-fluid services-img-swipe" alt="FREIGHT FORWARDING1">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="<?php echo url('/'); ?>/img/services details/FREIGHT FORWARDING2.webp"
                                        data-gallery="services-freight-forwarding" class="glightbox preview-link">
                                        <img src="<?php echo url('/'); ?>/img/services details/FREIGHT FORWARDING2.webp"
                                            class="img-fluid services-img-swipe" alt="FREIGHT FORWARDING2">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="<?php echo url('/'); ?>/img/services details/FREIGHT FORWARDING3.webp"
                                        data-gallery="services-freight-forwarding" class="glightbox preview-link">
                                        <img src="<?php echo url('/'); ?>/img/services details/FREIGHT FORWARDING3.webp"
                                            class="img-fluid services-img-swipe" alt="FREIGHT FORWARDING3">
                                    </a>
                                </div>
                            </div>
                        ...
                        <ul>
                            <li><i class="bi bi-check-circle"></i> <span x-text="translations.messages.ff_desc_1"></span>
                            </li>
                            <li><i class="bi bi-check-circle"></i> <span x-text="translations.messages.ff_desc_2"></span>
                            </li>
                            <li><i class="bi bi-check-circle"></i> <span x-text="translations.messages.ff_desc_3"></span>
                            </li>
                            <li><i class="bi bi-check-circle"></i> <span x-text="translations.messages.ff_desc_4"></span>
                            </li>
                        </ul>
