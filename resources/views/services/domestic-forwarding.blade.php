                        ...
                        <div class="service-details-slider swiper init-swiper">
                            ...
                            <div class="swiper-wrapper align-items-center">
                                <div class="swiper-slide">
                                    <a href="<?php echo url('/'); ?>/img/services details/DOMESTIC FORWARDING1.webp"
                                        data-gallery="services-domestic-forwarding" class="glightbox preview-link">
                                        <img src="<?php echo url('/'); ?>/img/services details/DOMESTIC FORWARDING1.webp"
                                            class="img-fluid services-img-swipe" alt="DOMESTIC FORWARDING1">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="<?php echo url('/'); ?>/img/services details/DOMESTIC FORWARDING2.webp"
                                        data-gallery="services-domestic-forwarding" class="glightbox preview-link">
                                        <img src="<?php echo url('/'); ?>/img/services details/DOMESTIC FORWARDING2.webp"
                                            class="img-fluid services-img-swipe" alt="DOMESTIC FORWARDING2">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="<?php echo url('/'); ?>/img/services details/DOMESTIC FORWARDING3.webp"
                                        data-gallery="services-domestic-forwarding" class="glightbox preview-link">
                                        <img src="<?php echo url('/'); ?>/img/services details/DOMESTIC FORWARDING3.webp"
