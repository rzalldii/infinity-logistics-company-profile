                    ...
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                        <div class="service-box">
                            ...
                            <div class="services-list">
                                ...
                                <a href="{{ route('customs-clearance') }}" class="active"><i
                        ...
                        <div class="service-details-slider swiper init-swiper">
                            ...
                            <div class="swiper-wrapper align-items-center">
                                <div class="swiper-slide">
                                    <a href="<?php echo url('/'); ?>/img/services details/CUSTOMS CLEARANCE1.webp"
                                        data-gallery="services-customs-clearance" class="glightbox preview-link">
                                        <img src="<?php echo url('/'); ?>/img/services details/CUSTOMS CLEARANCE1.webp"
                                            class="img-fluid services-img-swipe" alt="CUSTOMS CLEARANCE1">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="<?php echo url('/'); ?>/img/services details/CUSTOMS CLEARANCE2.webp"
                                        data-gallery="services-customs-clearance" class="glightbox preview-link">
                                        <img src="<?php echo url('/'); ?>/img/services details/CUSTOMS CLEARANCE2.webp"
                                            class="img-fluid services-img-swipe" alt="CUSTOMS CLEARANCE2">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="<?php echo url('/'); ?>/img/services details/CUSTOMS CLEARANCE3.webp"
                                        data-gallery="services-customs-clearance" class="glightbox preview-link">
                                        <img src="<?php echo url('/'); ?>/img/services details/CUSTOMS CLEARANCE3.webp"
                                            class="img-fluid services-img-swipe" alt="CUSTOMS CLEARANCE3">
                                    </a>
                                </div>
                            </div>
