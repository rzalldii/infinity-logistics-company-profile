...
window.addEventListener('load',navmenuScrollspy);document.addEventListener('scroll',navmenuScrollspy);const waButton=document.getElementById('waButton');const waPopup=document.getElementById('waPopup');const waClose=document.getElementById('waClose');window.addEventListener('scroll',()=>{if(window.scrollY>100){waButton.classList.add('show')}else{waButton.classList.remove('show');waPopup.classList.remove('open')}});waButton.addEventListener('click',()=>{waPopup.classList.toggle('open')});waClose.addEventListener('click',()=>{waPopup.classList.remove('open')});document.addEventListener('click',(e)=>{if(!e.target.closest('.wa-hover-zone')){waPopup.classList.remove('open')}})})()